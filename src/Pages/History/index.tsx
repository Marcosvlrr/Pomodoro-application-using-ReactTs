    ...
    <MainTemplate>
          ...
          {hasTasks && (
            <span className={styles.buttonContainer}>
              <DefaultButton icon={<TrashIcon />} color="red"
                aria-label="Apagar o historico" title="Apagar o historico"
      ...
      <Container>
              ...
              <thead>
                <tr>
                  <th onClick={() => handleSortTasks({ field: 'name' })} className={styles.thSort}>
                    Tarefa ↕</th>
                  <th onClick={() => handleSortTasks({ field: 'durationInMinutes' })} className={styles.thSort}>
                    Duração ↕</th>
        ...
        {!hasTasks && <p style={{ textAlign: 'center', fontWeight: 'bold' }}>
          Ainda não foi criada nenhuma tarefa</p>}
      </Container>
    </MainTemplate>
  )
